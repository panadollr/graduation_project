<div class="bg-light pt-3 pb-5">
    <div class="container">
                ...
                <ul class="nav nav-pills nav-border-anim justify-content-center" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="hot-all-link" data-toggle="tab" href="#hot-all-tab" role="tab"
                            aria-controls="hot-all-tab" aria-selected="true">Tất cả</a>
                    </li>
                    @foreach ($categoriesOfSaleProducts as $category)
                        <li class="nav-item">
                            <a class="nav-link" id="hot-{{ $category->id }}-products-link" data-toggle="tab"
                                href="#hot-{{ $category->id }}-products-tab" role="tab"
                                aria-controls="hot-{{ $category->id }}-products-tab"
        ...
        <div class="tab-content tab-content-carousel">
            ...
            @foreach ($categoriesOfSaleProducts as $category)
                <div class="tab-pane p-0 fade" id="hot-{{ $category->id }}-products-tab" role="tabpanel"
                    aria-labelledby="hot-{{ $category->id }}-products-link">
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                        data-owl-options='{
                        "nav": false, 
                        "dots": true,
