        ...
        <div class="container">
            <div class="header-left">
                ...
                <a href="{{ route('home') }}" class="logo">
                    <img src="{{ asset('client/assets/images/logo.png') }}" alt="" width="105" height="25">
                </a>
            ...
            <div class="header-right">
                ...
                <div class="account">
                    <a @auth 
                        href="{{ route('account.index') }}" title="Tài khoản"
                       @else
                    ...
                    >
                        ...
                        <p style='font-family: sans-serif;'>@auth Tài khoản của tôi @else Đăng nhập @endauth</p>
                    </a>
                </div>
