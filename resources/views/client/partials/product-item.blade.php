                <div class="product" style="border-radius: 10px">
                    <figure class="product-media">
                        ...
                        @if ($product->discount_percentage > 0)
                            <span class="product-label label-sale" style="font-size: 15px; font-weight: bold">Giảm giá
                    ...
                    <div class="product-body">
                        ...
                        <h3 class="product-title"><a
                                href="{{ route('product', ['product_slug' => $product->slug]) }}">{{ Str::limit($product->name, 30) }}</a>
                        ...
                        @else
                            <span class="product-label label-sale" style="font-size: 15px; font-weight: bold">hết
                                hàng</span>
                        @endif
                        <div class="ratings-container">
                            <div class="ratings">
                                <div class="ratings-val" style="width: {{ $product->reviews->avg('rating') * 20 }}%;">
                                </div><!-- End .ratings-val -->
                            </div><!-- End .ratings -->
