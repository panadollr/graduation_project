    ...
    @foreach($cartItems->take(5) as $cartItem)
        <div class="product">
            ...
            <figure class="product-image-container">
                <a href="{{ route('product', ['product_slug' => $cartItem->product->slug]) }}" class="product-image">
                    <img src="{{ $cartItem->product->featured_image }}" alt="product">
                </a>
            </figure>
            <a href="#" class="btn-remove" title="Remove Product" wire:click.prevent="removeFromCart({{ $cartItem->id }})">
