    ...
    {{-- <div>
        <style>
            ...
            <div class="form-group">
                ...
                <textarea id="comment" class="form-control" wire:model="comment" placeholder="Viết bình luận của bạn tại đây..."></textarea>
                @error('comment') <span class="text-danger">{{ $message }}</span> @enderror
            </div>
    
            <button class="btn btn-primary btn-block" 
                    @auth wire:click.prevent="submitReview" 
                ...
                <ul>
                    ...
                    <li>
                        <div class="comment">
                            ...
                            <div class="comment-body">
                                <div class="comment-user">
                                    <h4><a href="#">{{ $child->user->name }} (Quản trị viên)</a></h4>
